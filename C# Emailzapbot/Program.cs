// Create and opens an outlook draft (the office2016+ one, not the windows ver)
// Compile: dotnet publish --output {path} --runtime win10-x64 --configuration Release -p:PublishSingleFile=true -p:PublishTrimmed=false --self-contained
